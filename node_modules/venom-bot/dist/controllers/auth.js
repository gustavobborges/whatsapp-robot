...
exports.saveToken = exports.auth_InjectToken = exports.SessionTokenCkeck = exports.retrieveQR = exports.asciiQr = exports.isConnectingToPhone = exports.isInsideChat = exports.needsToScan = exports.isAuthenticated = exports.getInterfaceStatus = void 0;
/*
            ...
            switch (_a.label) {
                case 0:
                    if (!token) {
                        ...
                        if (fs_1.existsSync(pathToken)) {
                            token = JSON.parse(fs_1.readFileSync(pathToken).toString());
                        }
                    }
