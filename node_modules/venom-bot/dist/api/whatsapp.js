...
var Whatsapp = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.page.evaluate(function (messageId) {
    ...
    Whatsapp.prototype.useHere = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.page.evaluate(function () { return WAPI.takeOver(); })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    Whatsapp.prototype.logout = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.page.evaluate(function () { return WAPI.logout(); })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    Whatsapp.prototype.getMessageById = function (messageId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.page.evaluate(function (messageId) { return WAPI.getMessageById(messageId); }, messageId)];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        });
    ...
    Whatsapp.prototype.decryptFile = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var options, haventGottenImageYet, res, error_2, buff;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, axios_1.default.get(message.clientUrl.trim(), options)];
                    case 3:
                        res = _a.sent();
